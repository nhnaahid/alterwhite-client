                ...
                <div className="my-16">
                    <div className="w-4/5 md:w-3/5 mx-auto mt-5">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col space-y-2 mt-5">
                            ...
                            <input type="text" {...register("name", { required: true })} name="name" id="" placeholder="Name" className="border border-gray-300 p-2 md:p-3 rounded-lg" />
                            {errors.name && <span className="text-red-600">Name is required</span>}

                            <label>Your email address</label>
                            <input type="email" {...register("email", { required: true })} name="email" id="" placeholder="Email" className="border border-gray-300 p-2 md:p-3 rounded-lg" />
                            {errors.email && <span className="text-red-600">Email is required</span>}

                            <label>User Image</label>
                            <input type="text" {...register("image", { required: true })} id="image" placeholder="Image URL" className="border border-gray-300 p-2 md:p-3 rounded-lg" />
                                ...
                                <div>
                                    <div className="relative">
                                        <input type={showPassword ? 'password' : 'text'} {...register("password", {
                                            ...
                                            maxLength: 15,
                                            pattern: /(?=.*[A-Z])(?=.*[!@#$&*])(?=.*[0-9])(?=.*[a-z])/
                                        })} name='password' placeholder="Password" className="border border-gray-300 p-2 md:p-3 w-full rounded-lg" />
